...
export const useZoneTransition = ({
    ...
    const handleSanctuaryTransition = useCallback(async (targetZoneId?: string) => {
        ...
        if (targetZoneId === sanctuary.id || isInitialTransition) {
            ...
            const newZone = initializeZoneRuntime(JSON.parse(JSON.stringify(sanctuary)));
        ...
        return null;
    }, [player.currentGameRound.absoluteTick, gameState, sanctuary, setLoadingStatus, addLog, updatePlayer, triggerCompanionReactions]);
                    ...
                    try {
                        ...
                        if (result.success && result.data) {
                            ...
                            if (PersistenceService.isReady) {
                                ...
                                const entranceId = newZone.initial.entrance;
                            ...
                            setCurrentNodeId(newZone.initial.entrance);
