                    ...
                    return (
                      <div key={quest.id || index} className="relative bg-black/40 border border-amber-900/20 overflow-hidden group hover:border-amber-700/50 hover:bg-amber-950/10 transition-all duration-300">
                        <div className={`absolute left-0 top-0 bottom-0 w-[2px] transition-all ${
                            qType === 'kill' ? 'bg-red-600 shadow-[0_0_6px_rgba(220,38,38,0.6)] group-hover:bg-red-400' :
                        ...
                        <div className="p-3 pl-4">
                          <div className="flex items-start justify-between mb-2">
                            <span className={`text-[8px] uppercase px-1.5 py-0.5 border bg-black/40 ${
                                qType === 'kill' ? 'border-red-900/40 text-red-400' :
                ...
                <div className="space-y-3">
                  {activePlots.map((plot) => {
                    ...
                    return (
                      <div
                        key={plot.id}
                        className={`relative group bg-black/40 border transition-all duration-300 ${
                          isMain ? 'border-red-900/40 hover:border-red-600/60 hover:bg-red-950/20' : 'border-orange-900/20 hover:border-orange-700/50 hover:bg-orange-950/10'
                        }`}
                      >
