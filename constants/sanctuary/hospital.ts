...
export const ZONE_HOSPITAL: SanctuaryTemplate = {
    ...
    nodes: {
        ...
        "stairwell_b1": {
            ...
            threatLevel: 5,
            exits: [
                { targetId: "stairwell_f1", label: "上楼到一楼", type: 'local' },
        ...
        "stairwell_f2": {
            ...
            exits: [
                ...
                { targetId: "stairwell_f3", label: "上到三楼", type: 'local' }
            ]
        },
        "stairwell_f3": {
            name: "三楼楼梯间",
        ...
        "corridor_b1_service": {
            ...
            threatLevel: 10,
            childrenIds: ["generator_room", "morgue", "incinerator_room"],
            exits: [
                { targetId: "stairwell_b1", label: "返回楼梯", type: 'local' }
            ]
        },
        "generator_room": {
            name: "发电机房",
            ...
            threatLevel: 6,
            items: [
                { id: 'fuel_canister', name: '燃料罐', desc: '半满的柴油罐，沉重的能源补给。', type: 'material', rarity: 'common', discoveryThreshold: 10 },
                { id: 'spare_battery', name: '备用电池', desc: '标准外设能源块，仍有大半电量。', type: 'consumable', rarity: 'common', effects: [['restore_battery', 50]], discoveryThreshold: 15 },
                { id: 'basic_toolkit', name: '维修工具', desc: '一套耐用的通用五金维修套件。', type: 'material', rarity: 'common', discoveryThreshold: 5 },
                { id: 'scrap_parts', name: '废旧零件', desc: '杂乱但可再利用的金属与电子元件。', type: 'material', rarity: 'common', discoveryThreshold: 8 },
                { id: 'crowbar', name: '物理学圣剑 (撬棍)', desc: '沾着干涸血渍的重型撬棍。兼具破锁与碎颅双重功效。', type: 'weapon', rarity: 'common', weaponType: 'blunt', meleeDamage: 12, maxUses: 25, discoveryThreshold: 5 }
            ],
            interactions: [
                {
                    desc: '检查发电机状态',
            ...
            interactions: [
                {
                    ...
                    results: {
                        timeCost: 5,
                        soundEffect: 'scare',
                        narrative: '你屏住呼吸靠近，那股沉闷的撞击声却骤然停止。死寂中，柜内传出令人牙酸的多重和声，语气亲昵地呢喃着“手术……很成功……”。紧接着，尖锐的指甲疯狂刮擦金属的刺耳声响让你本能地踉跄后退。',
            ...
            interactions: [
                {
                    ...
                    results: {
                        ...
                        stateChange: {
                            sanity: -12,
                            gain: [{ id: 'key_staff_card_org', name: "组织通行证", desc: "印有螺旋标志的黑色磁卡，材质冰凉得不正常，散发出浓厚的不祥气息。", type: 'material', rarity: 'rare' }]
                        }
                    }
                }
            ]
        ...
        "corridor_f1_lobby": {
            ...
            threatLevel: 4,
            childrenIds: ["heavy_airlock", "chapel", "cafeteria", "gift_shop", "security_office", "emergency_room"],
            items: [
                {
                    id: "ration_list", name: "物资配给表", desc: "一张打印纸，底部有护士长颤抖的签名。", type: "document", rarity: "common", discoveryThreshold: 5,
        ...
        "heavy_airlock": {
            ...
            exits: [
                { label: "开启气密门", type: 'zone_transfer' }
            ]
        },
        "chapel": {
            name: "祈祷室",
            ...
            threatLevel: 3,
            items: [
                { id: 'rosary_beads', name: '染血念珠', desc: '缠绕着信徒执念的念珠。', type: 'accessory', rarity: 'rare', effects: [['maxSanity', 10]], discoveryThreshold: 15 }
            ],
            interactions: [
                {
                    desc: '点燃祈祷蜡烛',
        ...
        "cafeteria": {
            ...
            items: [
                { id: 'emergency_ration', name: '应急口粮', desc: '密封完好的压缩饼干，虽已过期但仍是硬通货。', type: 'consumable', rarity: 'common', effects: [['heal_hp', 10]], discoveryThreshold: 5 },
                { id: 'pure_water', name: '纯净水', desc: '未受污染的瓶装水。', type: 'consumable', rarity: 'common', effects: [['heal_hp', 5], ['heal_sanity', 10]], discoveryThreshold: 8 }
            ],
            childrenIds: ["kitchen"],
            interactions: [
                {
        ...
        "kitchen": {
            ...
            threatLevel: 8,
            items: [
                { id: 'high_purity_oil', name: "高级橄榄油", desc: "富豪特供的奢侈食材，如今用作燃料都显浪费。", type: 'material', rarity: 'common', discoveryThreshold: 15 }
            ],
            interactions: [
                {
                    desc: '打开嗡嗡作响的冰柜',
        ...
        "gift_shop": {
            ...
            interactions: [
                {
                    ...
                    results: {
                        timeCost: 5,
                        soundEffect: 'scare',
                        narrative: '你的手指刚触碰到一只孤零零的泰迪熊，它的纽扣眼便猛然崩裂，温热的黑色粘液喷溅上手背。同一瞬间，一阵稚嫩又扭曲的哭喊声毫无来源地在你脑内炸响。玩具的头部——以一种没有骨骼能实现的角度——缓缓歪向一边。',
            ...
            specificEnemy: {
                ...
                initialState: {
                    attribute: { strength: 4, agility: 8, knowledge: 2, perception: 5 },
                    equipState: { weapons: [null, null], armors: [null, null, null], accessories: [null, null, null, null, null] }
                },
                intentDistribution: { attack: 0.8, buff: 0.1, debuff: 0.1, observe: 0.0 },
                nextIntent: { type: 'attack', desc: '扑咬', value: 8 },
                lootTable: [
                    { id: 'infected_cotton', name: '异化棉絮', desc: '沾染粘液的填充物，或许可作引火材料。', type: 'material', rarity: 'common', dropProbability: 0.8 }
                ]
            },
        ...
        "security_office": {
            ...
            threatLevel: 5,
            items: [
                { id: 'battery_starter', name: "监控备用电源", desc: '沉重的工业级外设电池，电量尚足。', type: 'consumable', rarity: 'common', effects: [['restore_battery', 40]], discoveryThreshold: 10 }
            ],
            interactions: [
                {
                    desc: '回放残存录像',
        ...
        "emergency_room": {
            ...
            threatLevel: 14,
            items: [
                { id: 'bandage', name: '绷带', desc: '标准的军用止血绷带。', type: 'consumable', rarity: 'common', effects: [['heal_hp', 20]], quantity: 1, discoveryThreshold: 5 },
                { id: 'rusty_scalpel', name: '生锈的手术刀', desc: '勉强还能用来防身。', type: 'weapon', rarity: 'common', weaponType: 'dagger', meleeDamage: 5, maxUses: 10, discoveryThreshold: 10 }
            ],
        ...
        "ambulance_bay": {
            ...
            threatLevel: 10,
            items: [
                { id: 'scrap_parts', name: '废旧零件', desc: '拆卸救护车留下的五金构件。', type: 'material', rarity: 'common', quantity: 2, discoveryThreshold: 10 },
                { id: 'heavy_pipe_wrench', name: "重型管钳", desc: '沉重粗钝的工业级打击工具。', type: 'weapon', rarity: 'common', weaponType: 'blunt', meleeDamage: 8, maxUses: 15, discoveryThreshold: 15 }
            ],
            interactions: [
                {
                    desc: '检查爆炸痕迹',
        ...
        "corridor_f2_east": {
            ...
            threatLevel: 5,
            childrenIds: ["room_201", "room_202", "vip_ward", "room_203", "nurse_station", "doctors_lounge"],
            exits: [
                { targetId: "stairwell_f2", label: "返回楼梯口", type: 'local' }
            ]
        },
        "room_201": {
            name: "201号病房",
            ...
            items: [
                { id: 'sedative_starter', name: '镇静剂', desc: '能暂时稳住崩解理智的强效药物。', type: 'consumable', rarity: 'rare', effects: [['heal_sanity', 30]], discoveryThreshold: 5 },
                {
                    id: "eviction_notice", name: "清退通知", desc: "一张发黄皱褶的病历附页。", type: "document", rarity: "common", discoveryThreshold: 5,
        ...
        "room_202": {
            ...
            nodeNpc: {
                ...
                name: '利昂',
                gender: 'male',
                desc: "曾是这座医院的机修工。异变爆发时侥幸躲在机房深处逃过第一波收割。如今他攥着失踪女儿唯一留下的照片，在极度的自责与绝望的缝隙间，苦等一个永远不会到来的奇迹。",
                ...
                style: 'defense',
                initialState: {
                    attribute: { strength: 4, agility: 3, knowledge: 4, perception: 3 },
                    vital: { maxHp: 100, maxSanity: 60, maxStamina: 100, maxVigor: 80 },
                    inventory: [],
                    deck: [],
                    equipState: {
                        weapons: [{
                    ...
                    quest: {
                        '寻找女儿的线索': {
                            ...
                            goals: [{ id: 'infected_cotton', name: '异化棉絮', desc: '沾染粘液的填充物。', type: 'material', rarity: 'common' }],
                            rewards: [{ id: 'lucky_coin', name: '幸运硬币', desc: '利昂贴身携带的旧硬币，承载着微弱的祝福。', type: 'accessory', rarity: 'rare', effects: [['maxSanity', 15]] }],
                            difficulty: 2
                        }
                    }
                }
        ...
        "vip_ward": {
            ...
            threatLevel: 8,
            items: [
                { id: 'luxury_caviar', name: "高级黑松露", desc: "珍稀名贵的高能食品，末世中的奢侈补给。", type: 'consumable', rarity: 'epic', effects: [['heal_hp', 30]], quantity: 2, discoveryThreshold: 10 },
                {
                    id: "donation_receipt", name: "巨额捐赠收据", desc: "印有螺旋深渊基金会抬头的高级证券纸。", type: "document", rarity: "common", discoveryThreshold: 15,
        ...
        "room_203": {
            ...
            nodeNpc: {
                ...
                name: "莉安娜",
                gender: 'female',
                desc: "瞳孔涣散，精神已摇摆在彻底崩溃的悬崖边缘。她在三楼手术室无意间窥见了失控实验体的逃脱过程——更可怕的是，那个畸形之物转过无数复眼，用她死去祖母的声音，呼唤了她隐秘的童年乳名。",
                ...
                style: 'healer',
                initialState: {
                    attribute: { strength: 2, agility: 4, knowledge: 5, perception: 3 },
                    vital: { maxHp: 80, maxSanity: 50, maxStamina: 90, maxVigor: 70 },
                    inventory: [{ id: 'bandage', name: '绷带', desc: '医用绷带。', type: 'consumable', rarity: 'common', effects: [['heal_hp', 20]] }],
                    deck: [],
                    equipState: { weapons: [null, null], armors: [], accessories: [] },
                    trust: 40,
                    quest: {
                        '绝望的镇定': {
                            desc: '莉安娜的精神频临崩溃，急需强效镇静剂。可以在其他病房或医生休息室找找。',
                            goals: [{ id: 'sedative_starter', name: '镇静剂', desc: '能暂时稳住崩解理智的强效药物。', type: 'consumable', rarity: 'rare', effects: [['heal_sanity', 30]] }],
                            rewards: [{ id: 'medical_kit_storage', name: '医疗急救箱', desc: '顶级配置的综合急救箱，能挽救濒死生命。', type: 'consumable', rarity: 'epic', effects: [['heal_hp', 100]] }],
                            difficulty: 1
                        }
                    }
                }
            ...
            items: [
                { id: 'sedative_starter', name: '镇静剂', desc: '标准精神稳定剂。', type: 'consumable', rarity: 'rare', effects: [['heal_sanity', 30]], quantity: 2, discoveryThreshold: 5 }
            ],
        },
        "nurse_station": {
            name: "护士站",
            desc: "这里已被改为严密的临时指挥中心。白板上用血色马克笔画着触目惊心的物资告急趋势线。闪烁着锁定红灯的药品柜装上了重重大锁。摊开的工作日志里，记录着护士长从维持理智秩序一步步走向崩溃绝望的心路，以及那些不得不亲手处决融合变异病患的沉重抉择。",
            ...
            items: [
                { id: 'key_staff_card', name: '污损门禁卡', desc: '照片部分被指甲刮烂的电子门卡。', type: 'material', rarity: 'rare', discoveryThreshold: 15 }
            ],
        ...
        "med_storage": {
            ...
            items: [
                { id: 'medical_kit_storage', name: '医疗急救箱', desc: '顶级配置的综合急救箱，能挽救濒死生命。', type: 'consumable', rarity: 'epic', effects: [['heal_hp', 100]], discoveryThreshold: 20 }
            ],
            interactions: [
                {
                    desc: '阅读医疗手册',
        ...
        "doctors_lounge": {
            ...
            threatLevel: 5,
            items: [
                { id: 'sedative_starter', name: '镇静剂', desc: '急救精神类药物。', type: 'consumable', rarity: 'rare', effects: [['heal_sanity', 30]], discoveryThreshold: 5 }
            ],
            interactions: [
                {
                    desc: '阅读桌上的日记',
        ...
        "corridor_f3_surgery": {
            ...
            threatLevel: 18,
            childrenIds: ["operating_theatre", "scrub_room", "blood_bank", "icu"],
            exits: [
                { targetId: "stairwell_f3", label: "返回楼梯间", type: 'local' }
            ]
        },
        "operating_theatre": {
            name: "第一手术室",
            ...
            threatLevel: 20,
            items: [
                { id: 'ceremonial_dagger', name: '仪式匕首', desc: '刻满深渊符文的弯曲利刃，材质冰凉得灼手。', type: 'weapon', rarity: 'epic', weaponType: 'dagger', meleeDamage: 15, maxUses: 20, discoveryThreshold: 25 }
            ],
            interactions: [
                {
                    desc: '检查金属槽',
            ...
            specificEnemy: {
                ...
                initialState: {
                    attribute: { strength: 10, agility: 10, knowledge: 10, perception: 10 },
                    equipState: { weapons: [null, null], armors: [], accessories: [] }
                },
                intentDistribution: { attack: 0.6, buff: 0.1, debuff: 0.2, observe: 0.1 },
                nextIntent: { type: 'attack', desc: '准备挥击', value: 15 },
                lootTable: [
                    { id: 'abyss_crystal', name: '深渊结晶', desc: '高维能量的凝结物，散发着不祥的紫光。', type: 'material', rarity: 'epic', dropProbability: 1.0 },
                    { id: 'alien_scalpel', name: '异化手术刀', desc: '融合了外星生物组织的锋利手术刀。', type: 'weapon', rarity: 'epic', weaponType: 'dagger', meleeDamage: 20, maxUses: 15, dropProbability: 0.5 }
                ]
            },
        ...
        "scrub_room": {
            ...
            items: [
                {
                    id: "surgeon_note", name: "手术记录残页", desc: "被匆忙拼凑的机密文件。", type: "document", rarity: "common", discoveryThreshold: 10,
        ...
        "icu": {
            ...
            threatLevel: 17,
            items: [
                { id: "icu_morphine", name: "发光吗啡", desc: "液体泛着微弱紫光的异常镇痛剂。", type: 'consumable', rarity: 'rare', effects: [['heal_hp', 35]], discoveryThreshold: 15 }
            ],
            interactions: [
                {
                    desc: '关闭呼吸机',
        ...
        "corridor_f4_psych": {
            ...
            threatLevel: 18,
            childrenIds: ["therapy_room", "isolation_room", "ect_room"],
            exits: [
                { targetId: "stairwell_f4", label: "返回楼梯间", type: 'local' }
            ]
        },
        "therapy_room": {
            name: "团体治疗室",
            ...
            threatLevel: 10,
            items: [
                { id: 'weird_candy', name: '奇怪糖果', desc: '一颗包装古怪的糖果，能暂时安抚神经。', type: 'consumable', rarity: 'common', effects: [['heal_sanity', 5]], discoveryThreshold: 5 },
                {
                    id: "group_therapy_log", name: "治疗记录", desc: "封皮沾有干涸咖啡渍的绝望笔记。", type: "document", rarity: "common", discoveryThreshold: 10,
        ...
        "isolation_room": {
            ...
            interactions: [
                {
                    ...
                    results: {
                        timeCost: 5,
                        soundEffect: 'whisper',
                        narrative: '你鼓起勇气敲了敲铁门。那名漂浮的病患猛然旋身——他的面部没有任何五官，只有一个不断向内塌陷的深渊涡流。一道轰然宣示如烙铁般直接烫进你的意识：“我们即是深渊。”那颗旋转的虚无之首死死将你锁定，直到你被无形的威压逼退数步。',
                        stateChange: { sanity: -15 }
                    }
                }
            ],
            specificEnemy: {
                ...
                intentDistribution: { attack: 0.4, buff: 0.2, debuff: 0.3, observe: 0.1 },
                nextIntent: { type: 'debuff', desc: '低语侵蚀', value: 5 },
                lootTable: [
                    { id: 'void_echo', name: '虚无回声', desc: '封存着深渊低语的音频记录。', type: 'audio', rarity: 'epic', audioScript: '...[错乱的多重重唱]...理智是束缚，疯狂是飞升...[令人血液凝固的尖啸]...', dropProbability: 1.0 }
                ]
            },
            enemySpawnCondition: 'on_interact',
        },
        "ect_room": {
            ...
            threatLevel: 12,
            items: [
                { id: 'scrap_parts', name: '烧焦零件', desc: '过载电子仪器的残骸。', type: 'material', rarity: 'common', discoveryThreshold: 10 },
                { id: 'battery_starter', name: "稳压电源", desc: '沉重但完好的应急供电设备。', type: 'consumable', rarity: 'common', effects: [['restore_battery', 40]], discoveryThreshold: 15 }
            ],
            interactions: [
                {
                    desc: '启动ECT设备',
        ...
        "corridor_f5_admin": {
            ...
            threatLevel: 14,
            childrenIds: ["directors_office", "archive_room"],
            items: [
                {
                    id: "bribe_receipt", name: "贿赂收据", desc: "一张盖有深渊基金会钢印的机密文件。", type: "document", rarity: "common", discoveryThreshold: 5,
            ...
            exits: [
                { targetId: "stairwell_f5", label: "返回楼梯间", type: 'local' }
            ]
        },
        "directors_office": {
            name: "院长办公室",
            ...
            items: [
                { id: 'lucid_elixir', name: '清醒药剂', desc: '能将理智强力拉回现实界限的禁忌药物。', type: 'consumable', rarity: 'epic', effects: [['heal_sanity', 100]], discoveryThreshold: 25 }
            ],
            interactions: [
                {
                    desc: "解锁院长保险箱",
                    ...
                    results: {
                        ...
                        stateChange: {
                            gain: [{ id: "master_key", name: "主管磁卡", desc: "刻有Ω符号的最高权限磁卡，冰冷得烫手。", type: "material", rarity: "epic" }]
                        }
                    }
                },
                {
        ...
        "archive_room": {
            ...
            items: [
                {
                    id: "hysteria_report", name: "机密实验报告", desc: "盖有黑色螺旋印章的羊皮纸绝密文件。", type: "document", rarity: "rare", discoveryThreshold: 20,
                    documentContent: "1984年Ω级事故内部报告\n\n12名受试者在注射星神提取物后3小时内全部产生多维变异。\n其中9人肉体物理溃散，3人穿透钢筋混凝土墙壁后失踪。\n结论：确认降临前兆确凿。建议将后续死亡事件伪装为食物中毒，继续扩大样本规模。"
                },
                {
                    id: "patient_list_redacted", name: "实验对象名册", desc: "经过严重涂抹篡改的残酷名单。", type: "document", rarity: "rare", discoveryThreshold: 15,
                ...
                {
                    id: "evacuation_memo", name: "疏散备忘录", desc: '从碎纸机残骸中抢救出的焦边残页。', type: "document", rarity: "common", discoveryThreshold: 10,
                    documentContent: "董事会紧急决议备忘录\n\n撤离方案：今晚23:00准时于顶楼乘直升机撤离。\n资金已完成离岸转移。执行最终协议：锁死下层全部气密门，将非核心人员与实验废品永久隔离。\n让深渊宽恕这底层的血肉吧。我们，将成为新纪元的神选之民。"
                },
                {
                    id: "archive_tape", name: "绝密审讯录音", desc: "一盘布满灰尘的微型磁带。", type: "audio", rarity: "rare", discoveryThreshold: 12,
