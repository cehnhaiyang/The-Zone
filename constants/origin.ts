...
import { PLAYER_OCCULTIST, COMPANION_NURSE, COMPANION_GUARDIAN, PLAYER_VETERAN, PLAYER_INVESTIGATOR, } from './character';
...
export const ORIGIN_TEMPLATES: OriginTemplate[] = [
    {
         ...
         * 同伴：护士 Elara（治疗型辅助，初始信任尚可）
         * 难度：普通 — 有同伴、有医疗资源、庇护所防御中等
         */
        id: 'origin_hospital',
        title: '零号病房',
