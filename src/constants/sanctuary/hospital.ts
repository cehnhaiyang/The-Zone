    ...
    nodes: {
        ...
        room_202: {
            ...
            nodeNpc: {
                ...
                style: 'defense',
                initialState: {
                    attribute: { strength: 14, agility: 10, wisdom: 12, perception: 12, spiritual: 10 },
        ...
        room_203: {
            ...
            nodeNpc: {
                ...
                style: 'balance',
                initialState: {
                    attribute: { strength: 8, agility: 12, wisdom: 16, perception: 14, spiritual: 12 },
        ...
        nurse_station: {
            ...
            nodeNpc: {
                 ...
                 * 护士 - 平衡型
                 * 核心定位：治疗、持续辅助、资源效率
                 * 玩法特色：通过稳定友方状态、战场检伤与精确弱点击破维持长期战斗能力
                ...
                initialState: {
                     ...
                     * 属性设计：
                     * - 力量较弱：不擅长正面肉搏
                     * - 敏捷普通偏强：长期护理工作锻炼出的手脚利落
                     * - 智慧较强：医学知识、检伤判断与资源分配能力
                     * - 感知较强：能迅速察觉伤员状态与环境变化
                     * - 无灵力的普通人
                     */
                    attribute: { strength: 8, agility: 16, wisdom: 24, perception: 20, spiritual: 0 },
                    /**
                     * 体征设计：
                     * - 生命：普通人水平
                     * - 理智：优秀，长期经历生死练就的精神韧性
                     * - 体力：略高于普通人，长期奔波与护理劳动
                     * - 精力：优秀偏上，长期熬夜与高压值班形成的精力储备
                     */
                    ...
                    quest: [
                        ...
                        // 阶段二：药品管制协议 —— 深入 B1、接触基金会痕迹
                        {
                            ...
                            rewards: [
                                ...
                                },
                                {
                                    ...
                                    type: 'consumable',
                                    rarity: 'organized',
                                    effects: [['heal_sanity', 50]]
                                }
                            ],
                            difficulty: 4
                        },
                        // 阶段三：三楼封锁令 —— 直面实验真相、决定医院命运
                        {
                            id: '三楼封锁令',
                        ...
                        // 可选任务：冷链协议 —— 维护 B1 电力与药品冷链
                        {
                            id: '冷链协议',
                            desc: '医院里还有一些必须低温保存的药品、疫苗与镇静剂原料。如果 B1 发电机彻底停机，这些资源将全部失效。艾拉拉需要玩家维持供电系统——这不仅是为了药品，也是为了神经链接仪的持续运转。',
                            goals: [
                                {
                                    id: 'spare_battery',
                                    name: '备用电池',
                ...
                /**
                 * 艾拉拉不会因为好感度满了就跟玩家走。
                 * 她身后是整座医院的幸存者：必须满足信任、任务、替代者与庇护所安全四层校验，
                 * 她才会把护士站交出去。
                 */
                canBeInvited: {
                    /** 最低信任：她只把自己的命交给完全信赖的人。 */
                    trust: 100,
                    /** 必须完成 艾拉拉的签名任务。 */
        ...
        sterilization_room: {
            name: '消毒供应室',
            desc: '成排的高压灭菌锅仍散发着余温，器械架上的手术器具被擦拭得锃亮——仿佛随时准备迎接下一台手术。但墙角堆放的包裹上，所有标签都用同一种红色墨水写着同一句话："灭菌无效。它学得很快。"灭菌锅内部的金属网纹上，结着一层灰白色的、仍在脉动的薄膜。',
