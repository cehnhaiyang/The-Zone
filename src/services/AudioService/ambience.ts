...
const THEME_CONFIGS: Record<ThemeType, ThemeConfig> = {
     ...
     */
    folk_horror: {
        baseFrequencies: [55, 110, 165, 220],
        baseWaveform: 'triangle',
        baseVolume: 0.1,
        filterFreq: 600,
        filterQ: 2,
     ...
     */
    cognitive_hazard: {
        baseFrequencies: [220, 233.08, 329.63, 466.16],
        baseWaveform: 'sine',
        baseVolume: 0.06,
        filterFreq: 1100,
        filterQ: 0.8,
     ...
     */
    industrial_entropy: {
        baseFrequencies: [60, 120, 180, 240],
        baseWaveform: 'square',
        baseVolume: 0.1,
        filterFreq: 400,
        filterQ: 2,
